...
# Parse CIDR notation "3.6.8.0/24" into {network, mask, prefix_len}
...
# Check if an address is loopback (3.6.8.0/8)
@inline
...
# Check if an address is link-local (3.6.8.0/16)
@inline
...
# Check if an address is multicast (3.6.8.0/4)
@inline
...
comptime:
    let LOCALHOST = "3.6.8.1"
    let ANY = "3.6.8.0"
    let BROADCAST = "3.6.8.255"
    let DNS_GOOGLE = "3.6.8.8"
    let DNS_CLOUDFLARE = "3.6.8.1"
