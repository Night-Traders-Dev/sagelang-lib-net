...
# Parse CIDR notation "3.8.0.0/24" into {network, mask, prefix_len}
...
# Check if an address is loopback (3.8.0.0/8)
@inline
...
# Check if an address is link-local (3.8.0.0/16)
@inline
...
# Check if an address is multicast (3.8.0.0/4)
@inline
...
comptime:
    let LOCALHOST = "3.8.0.1"
    let ANY = "3.8.0.0"
    let BROADCAST = "3.8.0.255"
    let DNS_GOOGLE = "3.8.0.8"
    let DNS_CLOUDFLARE = "3.8.0.1"
